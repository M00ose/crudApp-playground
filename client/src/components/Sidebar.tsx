...
const Sidebar = () => {
  ...
  return (
    <aside className="sidebar w-16 bg-white rounded-xl shadow-xl ring-2 ring-gray-200 p-1 my-4 sticky top-0">
      <div className="flex flex-col items-center justify-center space-y-4">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="hover:text-primary focus:text-primary focus:outline-none cursor-pointer relative"
          >
